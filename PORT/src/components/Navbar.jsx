  ...
  return (
    <nav className="grid w-full grid-cols-[1fr_auto_1fr] items-center border-b-2 border-[#c7e5f4] bg-[#faedd6] px-4 py-2 sm:px-6 lg:px-10">
      ...
      <div className="flex items-center justify-center gap-5 sm:gap-8 md:gap-14 lg:gap-24">
        <NavLink to="/" className={({ isActive }) => `${navLinkBase} ${isActive ? 'text-[#fdade3]' : ''}`}>
          Home
        </NavLink>

        <NavLink to="/about" className={({ isActive }) => `${navLinkBase} ${isActive ? 'text-[#fdade3]' : ''}`}>
          About Me
        </NavLink>

        <NavLink to="/gallery" className={({ isActive }) => `${navLinkBase} ${isActive ? 'text-[#fdade3]' : ''}`}>
          Gallery
        </NavLink>
      </div>
      ...
      <div className="flex items-center justify-end gap-0 text-[#9d2f2d] sm:gap-0">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="h-6 w-6 fill-current sm:h-7 sm:w-7 md:h-7 md:w-7 lg:h-7 lg:w-7" aria-hidden="true">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="h-4 w-4 fill-current sm:h-5 sm:w-5" aria-hidden="true">
